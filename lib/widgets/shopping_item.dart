...
class _ShoppingItemWidgetState extends State<ShoppingItemWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListTile(
        title: Text(
          "${widget.shoppingItem.quantity!.toString().split(".")[1] == "0" ? widget.shoppingItem.quantity!.toInt().toString() : widget.shoppingItem.quantity!}x ${widget.shoppingItem.unit.name} ${widget.shoppingItem.name}",
